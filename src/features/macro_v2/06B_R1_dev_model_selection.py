...
def main():
    ...
    print(
        "MACRO-V2-HIST — "
        "06B-R1 DEV-ONLY MODEL SELECTION"
    )
    print("=" * 78)
    ...
    order_path = (
        out
        / "06B_R1_robust_feature_order.csv"
    )
    ...
    manifest = {
        ...
        "replication": {
            ...
            "purpose":
                (
                    "verify feature-count selection "
                    "after increasing the logistic "
                    "optimizer iteration budget and "
                    "recording convergence warnings"
                ),

            "model_definition_changed":
                False,

            "optimization_budget_changed":
                True,
        },
    ...
    write_json(
        out
        / "06B_R1_manifest_dev_model_selection.json",
        manifest,
    )
    ...
    print()
    print(
        "06B-R1 DEV MODEL SELECTION COMPLETE"
    )
